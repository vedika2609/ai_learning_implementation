...
import logging
import os
from utils.weavite_utils import generate_embedding

# Initialize models globally to load them once
reranker = FlagReranker('BAAI/bge-reranker-base', cache_dir=os.environ.get("MODEL_M3", "./models"), use_fp16=False)
